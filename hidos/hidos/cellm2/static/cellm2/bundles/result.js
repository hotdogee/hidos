...
$(function () {
  ...
  var path_prefix = '/media/cellm2/task/' + task_id + '/' + task_id;
  // check status
    ...
    $.ajax({
      ...
      success: function success(data, status) {
        ...
        if (data.data[0].result_status.toLowerCase() != "success") setTimeout(poll, 3000);else {
          ...
          $('#input-img').attr('src', '/media/cellm2/task/' + task_id + '/' + task_id + '_in.jpg');
          $('#input-download').attr('href', '/media/cellm2/task/' + task_id + '/' + task_id + '_in.jpg');
          $('#result-img').attr('src', '/media/cellm2/task/' + task_id + '/' + task_id + '_out.jpg');
          $('#result-download').attr('href', '/media/cellm2/task/' + task_id + '/' + task_id + '_out.jpg');
