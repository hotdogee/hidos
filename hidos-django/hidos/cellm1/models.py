...
from .tasks import run_cell_m1_task
...
class CellM1Task(CellTaskModel):
    ...
    def enqueue(self):
        ...
        # build command
        run_cell_m1_task(self.task_id,input_image_viewer_path, result_image_path, result_json_path , path_prefix)
        print(uploaded_image_path, result_image_path, result_json_path)

    def original_image(self):
        return format_html('<a href="/media/cellm1/task/{}/{}_in.jpg">Uploaded Image</a>', self.task_id,
                           self.task_id)
