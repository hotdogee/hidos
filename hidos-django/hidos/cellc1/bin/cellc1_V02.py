...
def cellCount_singleTask(image_input_path, image_output_path, json_path):
    ...
    if (np.logical_and(ret_all>20,tmp_sum>0).sum()==0):
        ...
        inx=(tmp_sum==tmp_sum[np.logical_and(ret_all>20,tmp_sum>0)].min()).argmax() #二值化門檻值須>20且size需相差4倍以內,滿足這些條件下,選擇size較小的layer
...
#image_path = "C:\\Users\\Aaron.Lin\\Desktop\\cellC1_issue_image\\cfb5d01f0b3c74411b4ae00dd03d8f60_in.jpg"
