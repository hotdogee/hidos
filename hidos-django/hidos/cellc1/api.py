...
from .serializers import CellC1TaskSerializer
...
class TaskViewSet(viewsets.ModelViewSet):
     ...
     * move(destination)
    """
    queryset = CellC1Task.objects.all()
    serializer_class = CellC1TaskSerializer
    ...
    def get_queryset(self):
        ...
        if user.username:
            ...
            if user.is_superuser:
                return CellC1Task.objects.all()
            else:
                return CellC1Task.objects.filter(user=self.request.user)
        else:
            return CellC1Task.objects.none()
