$(function () {
  ...
  var path_prefix = '/media/celln1/task/' + task_id + '/' + task_id;
  // check status
  var poll = function () {
    $.ajax({
      ...
      success: function (data, status) {
        ...
        if (data.status.toLowerCase() != "success")
          ...
          $('#input-download').attr('href', '/media/celln1/task/' + task_id + '/' + task_id + '_in.jpg');
          $('#result-img').attr('src', '/media/celln1/task/' + task_id + '/' + task_id + '_out.jpg');
          $('#result-download').attr('href', '/media/celln1/task/' + task_id + '/' + task_id + '_out.jpg');
