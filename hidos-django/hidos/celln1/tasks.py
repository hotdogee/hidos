...
from celln1.bin.CellN_v22 import CellNOne
...
def run_cell_n1_task(self, task_id,uploaded_image_path, result_image_path, result_json_path , path_prefix):
    import django
    django.setup()
    ...
    record = CellN1Task.objects.get(task_id__exact=task_id)
    ...
    data = {"channel": "#image-bug", "username": "celln1", \
            "text": "",
