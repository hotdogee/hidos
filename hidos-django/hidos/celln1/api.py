...
from .serializers import CellN1TaskSerializer

class TaskViewSet(viewsets.ModelViewSet):
    queryset = CellN1Task.objects.all()
    serializer_class = CellN1TaskSerializer
    ...
    def running(self, request, *args, **kwargs):
        running_tasks = CellN1Task.objects.filter(user=request.user, status__in=['queued', 'running'])
