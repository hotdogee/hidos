...
class CellATask(CellTaskModel):
    ...
    connectivity = models.IntegerField(null=True, blank=True)
    ...
    mean_branch_length = models.FloatField(null=True, blank=True)
    std_branch_length = models.FloatField(null=True, blank=True)
    segment = models.IntegerField(null=True, blank=True)
    total_segment_length = models.FloatField(null=True, blank=True)
    mean_segment_length = models.FloatField(null=True, blank=True)
    std_segment_length = models.FloatField(null=True, blank=True)
    mesh = models.IntegerField(null=True, blank=True)
    total_mesh_area = models.FloatField(null=True, blank=True)
    mean_mesh_area = models.FloatField(null=True, blank=True)
    std_mesh_area = models.FloatField(null=True, blank=True)
    total_mesh_perimeter = models.FloatField(null=True, blank=True)
    mean_mesh_perimeter = models.FloatField(null=True, blank=True)
    std_mesh_perimeter = models.FloatField(null=True,blank=True)
    ...
    def original_image(self):
        return format_html('<a href="/media/cella/task/{}/{}_in.jpg">Uploaded Image</a>',self.task_id, self.task_id)
