...
def run_cell_m3_task(self, task_id,uploaded_image_path, result_image_path, result_json_path , path_prefix):
    import django
    django.setup()
    ...
    record = CellM3Task.objects.get(task_id__exact=task_id)
    ...
    data = {"channel": "#image-bug", "username": "cellm3", \
            "text": "",
    ...
    # run
    try:
       cellm3(uploaded_image_path, result_image_path, result_json_path)
